...
def ed_capacitacion(Curp,id):
    ...
    cursor.execute( 'SELECT idestatus_cap, descripcion FROM estatus_capacitacion ')
    datos2 = cursor.fetchall()
    cursor.execute( ' SELECT a.curp, a.idcurso,c.nombre, a.fecha_inicio, a.fecha_termino, a.capacitador, a.idestatus_cap, b.descripcion ' 
                    ' FROM capacitacion a, estatus_capacitacion b, curso c '
                    ' WHERE a.idestatus_cap=b.idestatus_cap and a.idcurso=c.idcurso and a.curp=%s and a.idcurso=%s',(Curp,id))
    datos3=cursor.fetchall()
    conn.close()
